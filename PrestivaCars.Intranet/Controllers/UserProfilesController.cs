...
namespace PrestivaCars.Intranet.Controllers
{
    public class UserProfilesController : Controller
    {
        ...
        public UserProfilesController(PrestivaCarsContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("UserProfileId,UserId,FirstName,LastName,PhoneNumber,City,ProfileImagePath,IsActive")] UserProfile userProfile)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserProfileId,UserId,FirstName,LastName,PhoneNumber,City,ProfileImagePath,IsActive")] UserProfile userProfile)
        {
